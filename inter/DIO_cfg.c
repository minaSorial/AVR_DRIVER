...
const DIO_tstrPIN DIO_kastrPinCg [DIO_PIN_NUM]={
		...
		{DIO_PORTD,DIO_PIN2,DIO_INPUT, DIO_NOT_USED, DIO_PULLUP },



		{DIO_PORTD,DIO_PIN4,DIO_OUTPUT, DIO_LOW, DIO_NOT_USED },
		{DIO_PORTD,DIO_PIN5,DIO_OUTPUT, DIO_LOW, DIO_NOT_USED },
		{DIO_PORTD,DIO_PIN6,DIO_OUTPUT, DIO_LOW, DIO_NOT_USED }
